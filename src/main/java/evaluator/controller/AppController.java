...
public class AppController {
	...
	public void saveIntrebareIntoFile(String f, Intrebare newIntrebare) {
		intrebariRepository.saveIntrebareIntoFile(f, newIntrebare);
	}
	...
	public Statistica getStatistica() throws NotAbleToCreateStatisticsException{
		...
		for(String domeniu : intrebariRepository.getDistinctDomains()){
			// aici nu se trimitea bine al doilea parametru. Initial era:
			//intrebariRepository.getIntrebari.size() => se afisa nr total de intrebari la fiecare domeniu.
