...
public class InputValidation {
	...
	//am adaugat "validare" pentru id

	public static void validateId(String id) throws InputValidationFailedException{

		id = id.trim();

		if(id.equals(""))
			throw new InputValidationFailedException("Id-ul este vid!");
	}
